...
urlpatterns = [
    ...
    path('types/creer/', views.type_meuble_create, name='type_create'),
    ...
    path('meubles/creer/', views.meuble_create, name='meuble_create'),
    ...
    path('inventaires/creer/', views.inventaire_create, name='inventaire_create'),
    path('inventaires/<int:pk>/', views.inventaire_detail, name='inventaire_detail'),
    
    # Import/Export
    path('meubles/import/', views.meuble_import, name='meuble_import'),
    path('rapports/', views.generer_rapport, name='generer_rapport'),
    
    # Intégration avec maisons
    path('maisons/<int:maison_id>/meubles/', views.maison_meubles_list, name='maison_meubles_list'),
    
    # API AJAX
    path('api/meubles/maison/<int:maison_id>/', views.api_meubles_maison, name='api_meubles_maison'),
    path('api/meubles/<int:pk>/stats/', views.api_meuble_stats, name='api_meuble_stats'),
]