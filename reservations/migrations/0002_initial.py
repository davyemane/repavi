...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='client',
            field=models.ForeignKey(limit_choices_to={'role': 'CLIENT'}, on_delete=django.db.models.deletion.CASCADE, related_name='attributions', to=settings.AUTH_USER_MODEL, verbose_name='Client'),
        ),
        migrations.AddField(
            model_name='attribution',
            name='creee_par',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attributions_creees', to=settings.AUTH_USER_MODEL, verbose_name='Créée par'),
        ),
        migrations.AddField(
            model_name='attribution',
            name='maison',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attributions', to='home.maison', verbose_name='Maison'),
        ),
        migrations.AddField(
            model_name='disponibilite',
            name='maison',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disponibilites', to='home.maison', verbose_name='Maison'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attribution',
            name='reservation',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='attribution', to='reservations.reservation', verbose_name='Réservation liée'),
        ),
        migrations.AddField(
            model_name='paiement',
            name='type_paiement',
        ...
        migrations.AddIndex(
            model_name='attribution',
            index=models.Index(fields=['client'], name='reservation_client__c7c046_idx'),
        ),
        migrations.AddIndex(
            model_name='attribution',
            index=models.Index(fields=['maison'], name='reservation_maison__ab77d5_idx'),
        ),
        migrations.AddIndex(
            model_name='attribution',
            index=models.Index(fields=['statut'], name='reservation_statut_d885c5_idx'),
        ),
        migrations.AddIndex(
            model_name='attribution',
            index=models.Index(fields=['date_entree', 'date_sortie'], name='reservation_date_en_ffd070_idx'),
        ),
        migrations.AddIndex(
            model_name='paiement',
