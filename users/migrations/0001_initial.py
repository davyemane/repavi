    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_profil', models.ImageField(blank=True, default='users/default-avatar.png', null=True, upload_to='users/photos/')),
                ...
                ('type_utilisateur', models.CharField(choices=[('locataire', 'Locataire'), ('proprietaire', 'Propriétaire'), ('admin', 'Administrateur')], default='locataire', max_length=20)),
